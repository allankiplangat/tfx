...
#
def _make_trained_model(train_data: Iterator[Tuple[InputBatch, LabelBatch]],
  ...
  for epoch in range(1, num_epochs + 1):
    ...
    summary_writer.scalar('epoch_train_accuracy',
                          train_metrics['accuracy'], epoch)
    summary_writer.scalar('epoch_eval_loss', eval_metrics['loss'], epoch)
    summary_writer.scalar('epoch_eval_accuracy',
                          eval_metrics['accuracy'], epoch)
